{
  JDF.cli._.jasperro-shell.homeManager =
    { pkgs, config, impurity, ... }:
    {
      ...
      xdg.configFile = {
        "oh-my-posh/config.json".source = impurity.link ./_oh-my-posh/config.json;
        "nushell/user_config.nu".source = impurity.link ./_nushell/config.nu;
        "nushell/user_env.nu".source = impurity.link ./_nushell/env.nu;
      };
