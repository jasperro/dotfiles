...
## Type: QssColor
c.colors.completion.item.selected.bg = solarized['base01']

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = solarized['base01']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = solarized['base01']
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = solarized['base01']
...
## Type: QssColor
c.colors.statusbar.caret.selection.bg = solarized['base01']
...
## Type: QtColor
c.colors.tabs.indicator.start = solarized['base1']

## Color gradient end for the tab indicator.
## Type: QtColor
c.colors.tabs.indicator.stop = solarized['base1']
